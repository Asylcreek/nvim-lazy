...
vim.keymap.set("n", "<leader>cy", function()
  local ok, err = pcall(require("utils.context_line").insert, false)
  if not ok then
    vim.notify(err, vim.log.levels.ERROR)
  end
end, { desc = "Type context line below" })
vim.keymap.set("n", "<leader>cY", function()
  local ok, err = pcall(require("utils.context_line").insert, true)
  if not ok then
    vim.notify(err, vim.log.levels.ERROR)
  end
end, { desc = "Type context line above" })
